...
export class GovToken__checkpointsResultValue0Struct extends ethereum.Tuple {
  get _key(): BigInt {
...
export class GovToken__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class GovToken extends ethereum.SmartContract {
  static bind(address: Address): GovToken {
    return new GovToken("GovToken", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt,
  ): GovToken__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<GovToken__checkpointsResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt,
  ): ethereum.CallResult<GovToken__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint48,uint208))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<GovToken__checkpointsResultValue0Struct>(value[0].toTuple()),
    );
  }
  ...
  eip712Domain(): GovToken__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new GovToken__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<GovToken__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GovToken__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
